<nav class="navbar navbar-default navbar-fixed-top navbar-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav <?php if(__('voyager::generic.is_rtl') == 'true'): ?> navbar-left <?php else: ?> navbar-right <?php endif; ?>">
            <li>
                <a class="view_website" href="<?php echo e(route('home')); ?>">Pogledaj vebsajt</a>
            </li>
...
<?php /**PATH /home/physiohilfezug/public_html/vendor/tcg/voyager/src/../resources/views/dashboard/navbar.blade.php ENDPATH**/ ?>