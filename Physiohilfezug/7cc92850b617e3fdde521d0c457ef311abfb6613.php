<div class="products_sidebar mb-5">
    ...
    <?php if(($nivo === 'drugi') OR ($nivo === 'treci') OR ($nivo === 'cetvrti')): ?>
        <a class="show_top_categories" data-toggle="collapse" href="#top_categories" role="button" aria-expanded="false" aria-controls="top_categories">
            <span><?php echo e(__('shop_sidebar_top_categories')); ?> <i class="fa fa-angle-right"></i></span>
        </a>
        <div class="collapse" id="top_categories">
          <ul class="category_list">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div><?php /**PATH /home/physiohilfezug/public_html/resources/views/pages/shop/sidebar.blade.php ENDPATH**/ ?>